...
2. **Kennislaag (skills)**: repo-skills in `.github/skills/mcp-op/`.
...
Detailkennis en technische afspraken staan in skill `mcp-op`:

- `.github/skills/mcp-op/SKILL.md`
- `.github/skills/mcp-op/references/*.md`
